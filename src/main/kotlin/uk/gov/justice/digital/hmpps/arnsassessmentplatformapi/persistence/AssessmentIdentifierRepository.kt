...
interface AssessmentIdentifierRepository : JpaRepository<AssessmentIdentifierEntity, Long> {
  fun findByIdentifierTypeAndIdentifierAndAssessmentAssessmentType(type: IdentifierType, identifier: String, assessmentType: String): AssessmentIdentifierEntity?
}

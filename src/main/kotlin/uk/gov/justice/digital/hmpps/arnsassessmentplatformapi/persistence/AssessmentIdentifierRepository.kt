...
interface AssessmentIdentifierRepository : JpaRepository<AssessmentIdentifierEntity, Long> {
  fun findFirstByIdentifierTypeAndIdentifierAndAssessmentTypeAndCreatedAtBeforeOrderByCreatedAtDesc(type: IdentifierType, identifier: String, assessmentType: String, pointInTime: LocalDateTime): AssessmentIdentifierEntity?
}

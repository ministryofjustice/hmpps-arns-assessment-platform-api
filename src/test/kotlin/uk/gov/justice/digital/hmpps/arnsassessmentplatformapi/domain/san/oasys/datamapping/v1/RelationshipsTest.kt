...
class RelationshipsTest : SectionMappingTest(Relationships(), "v1.0") {
  @Test
  fun q1() {
    test(
      "o6-1",
      ...
      Given(Field.PERSONAL_RELATIONSHIPS_COMMUNITY_FAMILY_RELATIONSHIP, Value.UNKNOWN).expect("M"),
    )
  }
  ...
  fun q711da() {
    test(
      ...
      Given(Field.OFFENCE_ANALYSIS_VICTIM_OF_DOMESTIC_ABUSE, Value.YES)
        .and(Field.OFFENCE_ANALYSIS_VICTIM_OF_DOMESTIC_ABUSE_TYPE, Value.INTIMATE_PARTNER).expect("YES"),
      Given(Field.OFFENCE_ANALYSIS_VICTIM_OF_DOMESTIC_ABUSE, Value.YES)
        .and(Field.OFFENCE_ANALYSIS_VICTIM_OF_DOMESTIC_ABUSE_TYPE, Value.FAMILY_MEMBER_AND_INTIMATE_PARTNER).expect("YES"),
      Given(Field.OFFENCE_ANALYSIS_VICTIM_OF_DOMESTIC_ABUSE, Value.YES)
        .and(Field.OFFENCE_ANALYSIS_VICTIM_OF_DOMESTIC_ABUSE_TYPE, Value.FAMILY_MEMBER).expect("NO"),
    )
  }
  ...
  fun q712da() {
    test(
      ...
      Given(Field.OFFENCE_ANALYSIS_VICTIM_OF_DOMESTIC_ABUSE, Value.YES)
        .and(Field.OFFENCE_ANALYSIS_VICTIM_OF_DOMESTIC_ABUSE_TYPE, null).expect(null),
      Given(Field.OFFENCE_ANALYSIS_VICTIM_OF_DOMESTIC_ABUSE, Value.YES)
        .and(Field.OFFENCE_ANALYSIS_VICTIM_OF_DOMESTIC_ABUSE_TYPE, Value.FAMILY_MEMBER).expect("YES"),
      Given(Field.OFFENCE_ANALYSIS_VICTIM_OF_DOMESTIC_ABUSE, Value.YES)
        .and(Field.OFFENCE_ANALYSIS_VICTIM_OF_DOMESTIC_ABUSE_TYPE, Value.FAMILY_MEMBER_AND_INTIMATE_PARTNER).expect("YES"),
      Given(Field.OFFENCE_ANALYSIS_VICTIM_OF_DOMESTIC_ABUSE, Value.YES)
        .and(Field.OFFENCE_ANALYSIS_VICTIM_OF_DOMESTIC_ABUSE_TYPE, Value.INTIMATE_PARTNER).expect("NO"),
    )
  }
  ...
  fun q721da() {
    test(
      ...
      Given(Field.OFFENCE_ANALYSIS_PERPETRATOR_OF_DOMESTIC_ABUSE, Value.YES)
        .and(Field.OFFENCE_ANALYSIS_PERPETRATOR_OF_DOMESTIC_ABUSE_TYPE, Value.INTIMATE_PARTNER).expect("YES"),
      Given(Field.OFFENCE_ANALYSIS_PERPETRATOR_OF_DOMESTIC_ABUSE, Value.YES)
        .and(Field.OFFENCE_ANALYSIS_PERPETRATOR_OF_DOMESTIC_ABUSE_TYPE, Value.FAMILY_MEMBER_AND_INTIMATE_PARTNER).expect("YES"),
      Given(Field.OFFENCE_ANALYSIS_PERPETRATOR_OF_DOMESTIC_ABUSE, Value.YES)
        .and(Field.OFFENCE_ANALYSIS_PERPETRATOR_OF_DOMESTIC_ABUSE_TYPE, Value.FAMILY_MEMBER).expect("NO"),
    )
  }
  ...
  fun q722da() {
    test(
      ...
      Given(Field.OFFENCE_ANALYSIS_PERPETRATOR_OF_DOMESTIC_ABUSE, Value.YES)
        .and(Field.OFFENCE_ANALYSIS_PERPETRATOR_OF_DOMESTIC_ABUSE_TYPE, null).expect(null),
      Given(Field.OFFENCE_ANALYSIS_PERPETRATOR_OF_DOMESTIC_ABUSE, Value.YES)
        .and(Field.OFFENCE_ANALYSIS_PERPETRATOR_OF_DOMESTIC_ABUSE_TYPE, Value.FAMILY_MEMBER).expect("YES"),
      Given(Field.OFFENCE_ANALYSIS_PERPETRATOR_OF_DOMESTIC_ABUSE, Value.YES)
        .and(Field.OFFENCE_ANALYSIS_PERPETRATOR_OF_DOMESTIC_ABUSE_TYPE, Value.FAMILY_MEMBER_AND_INTIMATE_PARTNER).expect("YES"),
      Given(Field.OFFENCE_ANALYSIS_PERPETRATOR_OF_DOMESTIC_ABUSE, Value.YES)
        .and(Field.OFFENCE_ANALYSIS_PERPETRATOR_OF_DOMESTIC_ABUSE_TYPE, Value.INTIMATE_PARTNER).expect("NO"),
    )
  }
  ...
  fun q8() {
    test(
      "o6-8",
      Given().expect("3"),
      Given(Field.LIVING_WITH, emptyList()).expect("3"),
      Given(Field.PERSONAL_RELATIONSHIPS_COMMUNITY_IMPORTANT_PEOPLE, emptyList()).expect("3"),

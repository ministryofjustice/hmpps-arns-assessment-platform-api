...
class PractitionerAnalysisScenarios(private val sectionPrefix: String) {
  ...
  fun riskOfSeriousHarm(): Array<Given> = arrayOf(
    Given().expect(null),
  ...
  fun riskOfReoffending(): Array<Given> = arrayOf(
    Given().expect(null),
  ...
  fun strengthsOrProtectiveFactors(): Array<Given> = arrayOf(
    Given().expect(null),

...
class OffenceAnalysisTest : SectionMappingTest(OffenceAnalysis(), "v1.0") {
  ...
  fun victimAge() {
    mapOf(
      ...
      val entries: List<Map<String, PersistedValue>> = listOf(
        mapOf(
          Field.OFFENCE_ANALYSIS_VICTIM_AGE.lower to SingleValue(givenValue),
        ),
      )
  ...
  fun victimGender() {
    mapOf(
      ...
      val entries: List<Map<String, PersistedValue>> = listOf(
        mapOf(
          Field.OFFENCE_ANALYSIS_VICTIM_SEX.lower to SingleValue(givenValue),
        ),
      )
  ...
  fun victimRace() {
    mapOf(
      ...
      val entries: List<Map<String, PersistedValue>> = listOf(
        mapOf(
          Field.OFFENCE_ANALYSIS_VICTIM_RACE.lower to SingleValue(givenValue),
        ),
      )
  ...
  fun victimRelationship() {
    mapOf(
      ...
      val entries: List<Map<String, PersistedValue>> = listOf(
        mapOf(
          Field.OFFENCE_ANALYSIS_VICTIM_RELATIONSHIP.lower to SingleValue(givenValue),
        ),
      )
